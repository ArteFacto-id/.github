...
- **Scanning Artefact**: Using CNN models to predict weather patterns based on historical data.
- **Switch Language**: Using machine translation to switch languange app from english to bahasa.
